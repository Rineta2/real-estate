...
import { usePropertiesData } from '@/hooks/dashboard/admins/properties/lib/FetchProperties'

import ContentModal from '@/hooks/dashboard/admins/properties/modal/ContentModal'

import DeleteModal from '@/hooks/dashboard/admins/properties/modal/DeleteModal'

import ViewModal from '@/hooks/dashboard/admins/properties/modal/ViewModal'

import { Properties } from '@/hooks/dashboard/admins/properties/types/properties'
...
import PropertiesSkelaton from '@/hooks/dashboard/admins/properties/PropertiesSkelaton'
...
export default function PropertiesLayout() {
    ...
    const isAuthor = (property: Properties) => {
        return property.author.uid === user?.uid;
    };
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 py-4 px-4 sm:px-6 border-b border-gray-200 bg-primary-50 rounded-md mb-6 sm:mb-10">
                <div>
                    ...
                    <ul className="flex items-center gap-2 text-xs sm:text-sm">
                        <li className="font-medium"><Link href="/dashboard/admins">Dashboard</Link></li>
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <button
                                        ...
                                        disabled={!isAuthor(property)}
                                        className={`inline-flex items-center text-sm font-medium ${isAuthor(property)
                                            ? 'text-primary-600 hover:text-primary-700'
                                            : 'text-gray-400 cursor-not-allowed'
                                            }`}
                                        title={!isAuthor(property) ? "You can only edit your own properties" : "Edit property"}
                                    >
                                ...
                                <button
                                    ...
                                    title={!isAuthor(property) ? "You can only delete your own properties" : "Delete property"}
                                >
