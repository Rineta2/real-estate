...
import BlogSkeleton from '@/hooks/dashboard/admins/blog/BlogSkelaton'

import { Pagination } from '@/base/helper/Pagination'

import { SearchAndFilter } from '@/hooks/dashboard/admins/blog/components/SearchAndFilter'

import { DeleteModal } from '@/hooks/dashboard/admins/blog/modal/DeleteModal'

import { ViewModal } from '@/hooks/dashboard/admins/blog/modal/ViewModal'

import { BlogCard } from '@/hooks/dashboard/admins/blog/components/BlogCard'

import dynamic from 'next/dynamic'

const BlogModal = dynamic(() => import('@/hooks/dashboard/admins/blog/modal/ContentModal'), { ssr: false })
...
export default function BlogLayout() {
    ...
    const handleDelete = async (id: string) => {
        ...
        if (blogToDelete.author.name !== user?.displayName) {
    ...
    const handleEdit = (blog: Blog) => {
        if (blog.author.name !== user?.displayName) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {currentBlogs.map((blog) => (
                    <BlogCard
                        ...
                        canEdit={blog.author.name === user?.displayName}
                    />
                ))}
            </div>
