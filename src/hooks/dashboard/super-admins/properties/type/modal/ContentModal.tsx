...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/properties/type/types/schema';
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <div className="space-y-1">
                                <h3 className="text-2xl font-bold text-gray-900">
                                    {isEditing ? 'Edit Property Type' : 'Create New Property Type'}
                                </h3>
                                <p className="text-sm text-gray-500">Fill in the information below to {isEditing ? 'update' : 'create'} your property type</p>
                            </div>
                            <button
                                onClick={onClose}
