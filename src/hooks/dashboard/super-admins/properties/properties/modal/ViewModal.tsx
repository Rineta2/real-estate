...
export default function ViewModal({ isOpen, onClose, property }: ViewModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl max-w-7xl w-full overflow-hidden max-h-[90vh] flex flex-col">
                        ...
                        <div className="p-8 h-full flex flex-col justify-between">
                            <div className="flex justify-between items-start">
                                <div className="flex items-center gap-2">
                                    ...
                                    `}>
                                        <span className={`w-2 h-2 rounded-full mr-2 ${property.status === 'Publish' ? 'bg-green-500' : 'bg-yellow-500'}`}></span>
                                        {property.status}
                                    </div>
                                    <div className={`
                                        inline-flex items-center px-4 py-2 rounded-full text-sm font-medium
                                        ...
                                        ${property.statusProject === 'Selesai'
                                            ...
                                            : property.statusProject === 'Coming Soon'
                                                ...
                                                : 'bg-yellow-100/80 text-yellow-700 hover:bg-yellow-200/80'}
                                    `}>
                                        <span className={`w-2 h-2 rounded-full mr-2 ${property.statusProject === 'Selesai' ? 'bg-green-500' : property.statusProject === 'Coming Soon' ? 'bg-blue-500' : 'bg-yellow-500'}`}></span>
                            ...
                            <div className="text-white">
                                ...
                                <p className="text-white/80 line-clamp-2">{property.description}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {property.details.map((detail, index) => (
                                            <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                                                ...
                                                <span className="text-sm font-medium text-gray-700">{detail.title}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            {property.author && (
                                <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-all duration-300">
                                    ...
                                    <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900">{property.author.name}</h4>
                                            <p className="text-sm text-gray-500">{property.author.role}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">{formatTimestamp(property.createdAt)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">{formatTimestamp(property.updatedAt)}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
