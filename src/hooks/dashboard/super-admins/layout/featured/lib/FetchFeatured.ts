...
import {
  FeaturedContent,
  images,
} from "@/hooks/dashboard/super-admins/layout/featured/types/Featured";

// Cache untuk menyimpan hasil fetch
let contentCache: FeaturedContent[] | null = null;
...
export const useFeaturedData = () => {
  ...
  const createContent = async (data: FeaturedContent, imageUrl: images[]) => {
    try {
