...
import { ContentModalProps } from '@/hooks/dashboard/super-admins/pages/card-contact/types/CardContact';
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-gray-50/50 p-6 rounded-2xl space-y-6 border border-gray-100">
                                        ...
                                        {/* Google Maps Iframe Input */}
                                        <div className="space-y-2">
                                            <label htmlFor="googleMapsIframe" className="text-sm font-medium text-gray-700">Google Maps Iframe</label>
                                            <textarea
                                                id="googleMapsIframe"
                                            ...
                                            />
                                            <p className="text-sm text-gray-500">Paste the iframe code from Google Maps embed here</p>
                                    ...
                                    <div className="space-y-4">
                                            ...
                                            <div key={index} className="space-y-2">
                                                <div className="flex gap-2">
                                                    <input
                                                        ...
                                                        value={item.title}
                                                        onChange={(e) => {
                                                            const newTyping = [...formData.card];
                                                            newTyping[index] = { ...newTyping[index], title: e.target.value };
                                                            setFormData({ ...formData, card: newTyping });
                                                        }}
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            const newTyping = formData.card.filter((_, i) => i !== index);
                                                            setFormData({ ...formData, card: newTyping });
                                                        }}
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        const newTyping = [...formData.card];
                                                        newTyping[index] = { ...newTyping[index], href: e.target.value };
                                                        setFormData({ ...formData, card: newTyping });
                                                    }}
                                                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                                    placeholder="Link"
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                setFormData({
                                                    ...formData,
                                                    card: [...formData.card, { title: '', description: '', href: '' }]
                                                });
                                            }}
