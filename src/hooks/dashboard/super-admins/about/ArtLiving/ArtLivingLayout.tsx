...
import { ArtLivingContent } from '@/hooks/dashboard/super-admins/about/ArtLiving/types/ArtLiving'

const ContentModal = dynamic(() => import('@/hooks/dashboard/super-admins/about/ArtLiving/modal/ContentModal').then(mod => mod.ContentModal), {
    ssr: false
})

const DeleteModal = dynamic(() => import('@/hooks/dashboard/super-admins/about/ArtLiving/modal/DeleteModal').then(mod => mod.DeleteModal), {
    ssr: false
})

const ArtLivingSkelaton = dynamic(() => import('@/hooks/dashboard/super-admins/about/ArtLiving/ArtLivingSkelaton').then(mod => mod.default), {
    ssr: false
})

import { useArtLivingData } from '@/hooks/dashboard/super-admins/about/ArtLiving/lib/FetchArtLiving'

import { IoIosArrowForward } from 'react-icons/io'

const initialFormData: ArtLivingContent = {
    title: '',
    description: '',
    text: [],
    imageUrl: ''
...
export default function AboutLayout() {
    ...
    const [formData, setFormData] = useState<ArtLivingContent>(initialFormData)
    ...
    return (
        <section>
            <div className="flex justify-between items-center py-4 px-6 border-b border-gray-200 bg-primary-50 rounded-md mb-10">
                <div>
                    <h1 className="text-2xl font-bold">Art Of Living</h1>
                    <ul className="flex items-center gap-2">
                        ...
                        <li className="text-sm font-medium">Art Of Living</li>
                    </ul>
                </div>
