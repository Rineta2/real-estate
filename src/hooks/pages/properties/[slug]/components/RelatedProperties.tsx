...
import { RelatedPropertiesProps, PropertiesType } from "@/components/ui/properties/types/Properties"

export default function relatedProperties({ relatedProperties, currentSlug }: RelatedPropertiesProps) {
    return (
                            ...
                            <div className="bg-background rounded-xl sm:rounded-2xl overflow-hidden transition-all duration-300">
                                ...
                                <div className="py-5 px-2">
                                    <div className='flex justify-between items-center text-xs sm:text-sm text-gray-500 mb-2 sm:mb-3'>
                                        ...
                                        <span className="px-2 sm:px-3 py-1 bg-gray-100 rounded-full text-xs font-medium">{item.type}</span>
                                    </div>
